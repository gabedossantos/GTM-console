...
async def upload_conversations(
    ...
    """Upload conversation files for batch processing"""
    ...
    for file in files:
        ...
        # Process with AI
        analysis = await ai_service.analyze_interaction(text_content)
    ...
    return {"processed_files": len(files), "results": results}
